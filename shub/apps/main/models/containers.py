...
def delete_imagefile(sender,instance,**kwargs):
    '''delete image_file will handle deleting a local file on the filesystem,
       or given a container generated by a remote, will issue a delete request
       there.
    '''
...
class Container(models.Model):
    ...
    image = models.ForeignKey(ImageFile, null=True, blank=False) # an image upload, can be blank
