...
## Settings
The most important control panel for your collections is the Settings page. You can access it via the "Settings" button at the top of the collection view.
